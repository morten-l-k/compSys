...
echo "2202162" | ../id_query_binsort ../data/1records.tsv > test_output.txt
...
echo "45" | ../id_query_binsort ../data/1records.tsv > test_output.txt
...
echo "2202162" | ../id_query_binsort ../data/0records.tsv > test_output.txt
